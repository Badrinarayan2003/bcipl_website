...
const slides = [
    ...
    {
        title: "Build Your Career With Practical Skills",
        highlight: "Grow",
        description:
            "We focus on hands-on training and real industry exposure so you become job-ready from day one.",
        points: [
        ...
        bg: hero_banner,
        people: "/students-2.png",
    },
    {
        title: "Your Success Starts Here",
        highlight: "Achieve",
        description:
            "Join thousands of successful students who built careers through BCIPL.",
        points: [
