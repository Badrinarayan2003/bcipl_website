export default function JourneyTimeline() {
  ...
  const journeyData = [
    ...
    },
    {
      year: "2010",
      title: "Expansion",
      desc: "Introduced Banking, Finance & Insurance courses nationwide.",
    },
    {
      year: "2020",
      title: "Digital Transformation",
      desc: "Adopted online learning models to reach students across India.",
    },
    {
      year: "2025",
      title: "1178+ Students Trained",
      desc: "Became a trusted brand in finance education and placement.",
    },
  ];
    ...
    <section className="w-full py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative hidden lg:block">
          ...
          {/* Vertical spine */}
          <div className="absolute right-32 top-0 h-full w-[2px] bg-orange-200" />
          ...
          <div className="space-y-24">
            {journeyData.map((item, i) => (
              <div key={i} className="relative flex items-center">
                ...
                {/* Curve connector */}
                <div className="absolute right-32 w-24 h-24 border-r-2 border-b-2 border-orange-200 rounded-br-full" />

                {/* Year bubble */}
                <div className="absolute right-28 w-14 h-14 bg-orange-500 text-white rounded-full flex items-center justify-center font-bold shadow-md">
                  {item.year}
                </div>
        ...
        <div className="lg:hidden space-y-10">
          {journeyData.map((item, i) => (
            <div key={i} className="relative pl-10">
              ...
              {/* Line */}
              <div className="absolute left-4 top-0 h-full w-[2px] bg-orange-200" />

              {/* Dot */}
              <div className="absolute left-0 w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center text-xs font-bold">
                {item.year}
              </div>
